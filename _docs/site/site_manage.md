...
## Manage Sites table
Each newly saved [site]({{ site.baseur1 }}/docs/site/site) will appear as a row in the table. The all 0s site code refers to the agency headquarters. The table is sorted by increasing site code by default, but you can sort the table by any field by clicking on the column name.
