...
v5: true
gateway-url: https://gateway.vectorsurv.org/v5/mosquito/pool/manage
---

View saved pool records.
...
**Aside:**  
There is a summary box on the right-hand side of the screen describing
the number of pools by species for selected start/end timeframe. You can
open/close this aside menu by clicking the arrow tab on the far-right
edge of the page
